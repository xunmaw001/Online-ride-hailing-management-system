	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="车辆颜色" prop="cheliangyanse">
					<el-select :disabled="ro.cheliangyanse" v-model="ruleForm.cheliangyanse" placeholder="请选择车辆颜色" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="车辆颜色" prop="cheliangyanse">
					<el-input v-model="ruleForm.cheliangyanse"
						placeholder="车辆颜色" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="车辆类型" prop="cheliangleixing">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="车辆状态" prop="cheliangzhuangtai">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="车辆状态" prop="cheliangzhuangtai">
					<el-input v-model="ruleForm.cheliangzhuangtai"
						placeholder="车辆状态" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="注册时间" prop="zhuceshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.zhuceshijian" label="注册时间" prop="zhuceshijian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="每公里/元" prop="danjia">
					<el-input v-model="ruleForm.danjia" placeholder="每公里/元" clearable  :readonly="ro.danjia"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="每公里/元" prop="danjia">
					<el-input v-model="ruleForm.danjia" placeholder="每公里/元" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="车辆详情" prop="cheliangxiangqing">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.cheliangxiangqing" label="车辆详情" prop="cheliangxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.cheliangxiangqing"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.cheliangxiangqing = this.ruleForm.cheliangxiangqing.replace(reg,'../../../ssmzzg74/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
