	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="车辆品牌" prop="cheliangpinpai">
					<el-input v-model="ruleForm.cheliangpinpai" placeholder="车辆品牌" clearable  :readonly="ro.cheliangpinpai"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="车辆品牌" prop="cheliangpinpai">
					<el-input v-model="ruleForm.cheliangpinpai" placeholder="车辆品牌" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="起步价" prop="qibujia">
					<el-input v-model="ruleForm.qibujia" placeholder="起步价" clearable  :readonly="ro.qibujia"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="起步价" prop="qibujia">
					<el-input v-model="ruleForm.qibujia" placeholder="起步价" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="单价" prop="danjia">
					<el-input v-model="ruleForm.danjia" placeholder="单价" clearable  :readonly="ro.danjia"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="单价" prop="danjia">
					<el-input v-model="ruleForm.danjia" placeholder="单价" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="公里" prop="xingshijuli">
					<el-input v-model="ruleForm.xingshijuli" placeholder="公里" clearable  :readonly="ro.xingshijuli"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="公里" prop="xingshijuli">
					<el-input v-model="ruleForm.xingshijuli" placeholder="公里" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="下车点" prop="xiachedian">
					<el-input v-model="ruleForm.xiachedian" placeholder="下车点" clearable  :readonly="ro.xiachedian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="下车点" prop="xiachedian">
					<el-input v-model="ruleForm.xiachedian" placeholder="下车点" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="到达时间" prop="daodashijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.daodashijian" label="到达时间" prop="daodashijian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="订单备注" prop="dingdanbeizhu">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.dingdanbeizhu" label="订单备注" prop="dingdanbeizhu">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.dingdanbeizhu"></span>
                </el-form-item>
...
export default {
	...
	computed: {
		...
		zongfeiyong:{
			...
			get: function () {
				return 1*this.ruleForm.danjia*this.ruleForm.xingshijuli+parseFloat(this.ruleForm.qibujia==""?0:this.ruleForm.qibujia)
			}
		},
	},
	created() {
		this.ruleForm.daodashijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xingshijuli'){
							this.ruleForm.xingshijuli = obj[o];
							this.ro.xingshijuli = true;
							continue;
						}
						if(o=='zongfeiyong'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.dingdanbeizhu = this.ruleForm.dingdanbeizhu.replace(reg,'../../../ssmzzg74/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
