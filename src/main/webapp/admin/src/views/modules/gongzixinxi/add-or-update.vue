<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="月份" prop="yuefen">
					<el-input v-model="ruleForm.yuefen" placeholder="月份" clearable  :readonly="ro.yuefen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="月份" prop="yuefen">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="基本工资" prop="jibengongzi">
					<el-input v-model="ruleForm.jibengongzi" placeholder="基本工资" clearable  :readonly="ro.jibengongzi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="基本工资" prop="jibengongzi">
					<el-input v-model="ruleForm.jibengongzi" placeholder="基本工资" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="奖金提成" prop="jiangjinticheng">
					<el-input v-model="ruleForm.jiangjinticheng" placeholder="奖金提成" clearable  :readonly="ro.jiangjinticheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="奖金提成" prop="jiangjinticheng">
					<el-input v-model="ruleForm.jiangjinticheng" placeholder="奖金提成" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="补贴费用" prop="butiefeiyong">
					<el-input v-model="ruleForm.butiefeiyong" placeholder="补贴费用" clearable  :readonly="ro.butiefeiyong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="补贴费用" prop="butiefeiyong">
					<el-input v-model="ruleForm.butiefeiyong" placeholder="补贴费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="实发工资" prop="shifagongzi">
					<el-input v-model="shifagongzi" placeholder="实发工资" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shifagongzi" label="实发工资" prop="shifagongzi">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../ssmzzg74/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
