	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.qianyuewenjian" label="签约文件" prop="qianyuewenjian">
					<file-upload
						tip="点击上传签约文件"
						action="file/upload"
						:limit="1"
						:multiple="true"
						:fileUrls="ruleForm.qianyuewenjian?ruleForm.qianyuewenjian:''"
						@change="qianyuewenjianUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.qianyuewenjian" label="签约文件" prop="qianyuewenjian">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"0","background":"#67D4B2","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.qianyuewenjian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.qianyuewenjian" label="签约文件" prop="qianyuewenjian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="签约日期" prop="qianyueriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.qianyueriqi" label="签约日期" prop="qianyueriqi">
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='qianyuewenjian'){
							this.ruleForm.qianyuewenjian = obj[o];
							this.ro.qianyuewenjian = true;
							continue;
						}
						if(o=='qianyueriqi'){
	...
	if(this.ruleForm.qianyuewenjian!=null) {
		this.ruleForm.qianyuewenjian = this.ruleForm.qianyuewenjian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    qianyuewenjianUploadChange(fileUrls) {
	    this.ruleForm.qianyuewenjian = fileUrls;
    },
  }
};
</script>
