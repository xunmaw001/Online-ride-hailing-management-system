	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="上车地点" prop="shangchedidian">
					<el-input v-model="ruleForm.shangchedidian" placeholder="上车地点" clearable  :readonly="ro.shangchedidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="上车地点" prop="shangchedidian">
					<el-input v-model="ruleForm.shangchedidian" placeholder="上车地点" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="预约备注" prop="yuyuebeizhu">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.yuyuebeizhu" label="预约备注" prop="yuyuebeizhu">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.yuyuebeizhu"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.yuyuebeizhu = this.ruleForm.yuyuebeizhu.replace(reg,'../../../ssmzzg74/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
