...
<div class="recommend" :style='{"padding":"0px 10px 10px 10px","margin":"20px 0px 0px","borderColor":"#dbd9f4","borderRadius":"8px","background":"#fff","borderWidth":"2px 1px 1px 1px","width":"100%","borderStyle":"solid","height":"auto","order":"3"}'>
    ...
    <div class="title" :style='{"width":"260px","margin":"0px auto","lineHeight":"42px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221105/bb1ea9437beb4e1da8fcd1583db2f111.png) no-repeat,radial-gradient(circle, rgba(219,217,244,1) 0%, rgba(181,177,240,1) 100%)","height":"42px"}'>
		<span :style='{"color":"#333","fontSize":"22px"}'>车辆信息推荐</span>
	</div>
	...
	<div class="list list3 index-pv1">
		<div :style='{"width":"100%","padding":"10px","margin":"12px 0 0px 0","borderRadius":"8px","background":"#fff","height":"auto"}' class="swiper-container" id="recommendcheliangxinxi">
			<div class="swiper-wrapper">
				<div class="swiper-slide animation-box" :style='{"border":"0","cursor":"pointer","padding":"0 0 8px 0","borderRadius":"8px","background":"rgba(242, 242, 242,.6)","fontSize":"0","position":"relative"}' v-for="(item,index) in cheliangxinxiRecommend" :key="index" @click="toDetail('cheliangxinxiDetail', item)">
					<img :name="item.id" :style='{"border":"0","width":"100%","borderRadius":"8px 8px 0 0","height":"220px"}' v-if="item.zhaopian.substr(0,4)=='http'" :src="item.zhaopian.split(',')[0]" alt="" />
					<img :name="item.id" :style='{"border":"0","width":"100%","borderRadius":"8px 8px 0 0","height":"220px"}' v-else :src="baseUrl + (item.zhaopian?item.zhaopian.split(',')[0]:'')" alt="" />
					<div class="line1" :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#333","background":"#f8f8fc"}'>车牌号:{{item.chepaihao}}</div>
					<div class="line1" :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#333","background":"#f8f8fc"}'>车辆品牌:{{item.cheliangpinpai}}</div>
					<div class="line1" :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#333","background":"#f8f8fc"}'>车辆状态:{{item.cheliangzhuangtai}}</div>
				</div>
			</div>
			<!-- 如果需要导航按钮 -->
	...
	<div @click="moreBtn('cheliangxinxi')" :style='{"border":"0","cursor":"pointer","margin":"10px auto","borderRadius":"30%","textAlign":"center","background":"radial-gradient(circle, rgba(231,230,244,1) 0%, rgba(219,217,244,1) 100%),#dbd9f4","display":"block","width":"18%","lineHeight":"32px"}'>
		...
		getList() {
          ...
          autoSortUrl = "cheliangxinxi/autoSort";
			this.$http.get(autoSortUrl, {params: {
				...
				if (res.data.code == 0) {
					this.cheliangxinxiRecommend = res.data.data.list;
					...
					this.$nextTick(() => {
						new Swiper('#recommendcheliangxinxi', options)
					})
