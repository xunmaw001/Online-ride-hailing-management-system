<template>
	...
	<div class="container" :style='{"minHeight":"100vh","backgroundColor":"0","alignItems":"center","backgroundImage":"url(http://codegen.caihongy.cn/20221026/dfa16b1e27da4aacaf5408c8a8adddab.png)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"0","margin":"0","borderRadius":"10px","top":"0","background":"#fff","width":"570px","position":"absolute","right":"0","height":"100%"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"20px 0","lineHeight":"1.5","fontSize":"24px","color":"#ab85d3","textAlign":"center"}'>网约车管理系统注册</p></div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"15px auto"}' v-if="tableName=='yonghu'" prop="lianxidianhua">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"15px auto"}' v-if="tableName=='siji'" prop="sijizhanghao">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>司机账号：</div>
				<el-input v-model="registerForm.sijizhanghao"  placeholder="请输入司机账号" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"15px auto"}' v-if="tableName=='siji'" prop="mima">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"15px auto"}' v-if="tableName=='siji'" prop="mima">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"15px auto"}' v-if="tableName=='siji'" prop="sijixingming">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>司机姓名：</div>
				<el-input v-model="registerForm.sijixingming"  placeholder="请输入司机姓名" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"15px auto"}' v-if="tableName=='siji'" prop="xingbie">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>性别：</div>
                <el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
                  <el-option
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"15px auto"}' v-if="tableName=='siji'" prop="lianxifangshi">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"15px auto"}' v-if="tableName=='siji'" prop="touxiang">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>头像：</div>
                <file-upload
					tip="点击上传头像"
					action="file/upload"
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            var url=this.tableName+"/register";
               ...
               if(`siji` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
                this.$message.error(`两次密码输入不一致`);
                return
               }
